...
import 'package:flutter_openim_widget/src/message_manager.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:rxdart/rxdart.dart';

import '../flutter_openim_widget.dart';
import 'chat/chat_hint_text_view.dart';
import 'chat/chat_item_container.dart';
...
class _ChatItemViewState extends State<ChatItemView> {
  ...
  Widget _buildChildView() {
    ...
    if (_message.isTextType) {
      ...
      child = ChatVoiceView(
        isReceived: _message.isRead ?? false,
    ...
    return child = ChatItemContainer(
      ...
      child: GestureDetector(
        ...
        child: child ?? ChatText(text: '暂不支持的消息类型'),
      ),
    );
  }
}
